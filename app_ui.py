...
class HuffmanApp:
    def __init__(self, root):
        ...
        self.lbl_comp_size = tk.Label(stats_frame, text="Compressed Size: --", font=("Arial", 10), bg="white",
                                      anchor="w")
        self.lbl_comp_size.pack(fill=tk.X, pady=2)

        self.lbl_ratio = tk.Label(stats_frame, text="Space Optimization Ratio: --", font=("Arial", 10, "bold"),
                                  bg="white", fg="#27ae60", anchor="w")
        self.lbl_ratio.pack(fill=tk.X, pady=2)

        self.lbl_time = tk.Label(stats_frame, text="Execution Runtime Latency: --", font=("Arial", 10), bg="white",
                                 anchor="w")
        self.lbl_time.pack(fill=tk.X, pady=2)

        self.lbl_complexity = tk.Label(stats_frame, text="Theoretical Complexity: Time: O(N log K) | Space: O(K)",
                                       font=("Arial", 9, "italic"), bg="white", fg="#7f8c8d", anchor="w")
