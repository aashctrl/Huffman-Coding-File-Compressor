...
K
 ...
 via Min-Heap processing	
O
(
K
)
 node generation bounds
Bitstream Stream Extraction	
O
(
N
)
...
N
 ...
 bit allocation structure
🛠️ How to Set Up and Run
Ensure you have Python 3.x installed in your environment.
Create a Folder named 'src' and save 'app_ui.py' and 'huffman_engine.py' files in it.
Create a Folder named 'sample' and save 'demo.txt' in it for testing.
After saving files, run and test to check how it's working alright.
